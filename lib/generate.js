                ...
                if(typeof resp === "object"){   
                   ...
                   console.log("current key -->",key);
                    ...
                    if(typeof value === 'object' ){   
                        ...
                        console.log("Action path result 1",ACTION.PATH.split("/").pop());
                        console.log("Action path result 1",path.split(".").pop());
                        let latestPath = ACTION.PATH.split("/").pop();

                    if (key === "properties" && ((!value.data) && (!value.items) && (!value.latestPath))){
                            console.log("included",Object.keys(value).includes(path.split(".").pop()));
                            console.log("Action path result 2",(ACTION.PATH.split("/").pop()));
